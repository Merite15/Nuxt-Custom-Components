<template>
    <div class="bg-gray-200/40 pb-80 h-full">
        <div class="w-10/12 mx-auto">
            <div>
                <h2>Datatable</h2>
                <CustomDatatableModel :columns="tblHeaders" :entries="tblData" filterBy="column" :sortBy="['id', 'asc']"
                    @checklist="checks">
                    <template #default>
                        <div class="flex gap-3">
                            <button type="button" @click="pressButton(['add new'])"
                                class="inline-block px-6 py-2.5 mr-3 bg-red-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-red-700 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-out">Add
                                New</button>
                        </div>
                    </template>
                    <template #action="{ entry }">
                        <div class="flex gap-5px">
                            <button type="button" @click="pressButton(entry)"
                                class="inline-block px-6 py-2.5 mr-3 bg-red-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-red-700 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-out">Edit</button>
                            <button type="button" @click="pressButton(entry)"
                                class="inline-block px-6 py-2.5 mr-3 bg-red-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-red-700 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-out">Delete</button>
                        </div>
                    </template>
