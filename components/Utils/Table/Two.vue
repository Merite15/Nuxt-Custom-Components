        ...
        <div class=" flex items-center justify-center overflow-hidden">
            <div class="w-full px-5">
                <div class="shadow-md rounded">
                    <table ref="printTemplate" class="min-w-max shadow-md w-full table-auto">
                        <thead>
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <div class="mr-2">
                                            <img alt="image" class="w-6 h-6 rounded-full"
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                        <img alt="image" class="w-6 h-6 rounded-full border-gray-200 border transform hover:scale-125"
                                            src="https://randomuser.me/api/portraits/men/1.jpg" />
                                        <img alt="image" class="w-6 h-6 rounded-full border-gray-200 border -m-1 transform hover:scale-125"
                            ...
                            <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <div class="mr-2">
                                            <img alt="image" class="w-6 h-6" src="https://img.icons8.com/color/100/000000/vue-js.png" />
                                        </div>
