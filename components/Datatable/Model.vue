...
<template>
    <div :class="theme.wrapper.tableWrap">
        <div :class="theme.wrapper.tableTop">
            <div :class="theme.wrapper.tableTopLeft">
        ...
        <CustomDatatableTable :columns="columns" :entries="paginatedEntries" @checklist="checkedRows" :filter="filter"
            @filter="filterColumns" @sort="sortColumns" :rows="entries" :theme="{ ...theme.input, ...theme.table }" />
        <div :class="theme.wrapper.tableBottom">
            <div :class="theme.wrapper.tableBottomLeft">
                ...
                <div class="theme.wrapper.tableInfo">from {{ getPageInfo.start }} to {{ getPageInfo.end }} of
                    {{ getPageInfo.length }}</div>
            </div>
            <div :class="theme.wrapper.tableBottomRight">
                <CustomDatatablePagination :items="getPagination" v-model="getCurrentPage" :total="getPages"
